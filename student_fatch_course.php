                  ...
                  <div id="search_box_middle">
                      ...
                      <table>
                          <tr>
                            ...
                            <th style="padding:10px 15px;background-color:#FF0000 ;"> Delete Course </th>
                          </tr>
                        ...
                        <?php 
                          ...
                          <tr>
                            ...
                            <td style="padding:10px 15px;background-color:#FF0000;"><input type="submit" name="delete" value="delete"></td>
                          </tr>
                          <?php
                          }
                        }
