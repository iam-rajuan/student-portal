  ...
  <div class="body_section">
    ...
    <div id="container" class="right_part">
        ...
        <h2 style="padding:10px;border-bottom:2px solid rgb(17, 143, 143);color:rgb(17, 143, 143);">Password Change</h2>
          <form action="teacher_reset_pass.php" method="POST">
            <label for="current-password">Teacher Email </label>
            <input type="text" id="current-password" name="admin_mail" placeholder="teacher Email" required>
