...
<header>
  <h1><marquee behavior="scroll" direction="left">Welcome to student portal of Green University of Bangladesh. Admision open Fall_2024 . Reminder---Final Exam start 25 june 2024</marquee></h1>
</header>
...
<img src="logo/logo.png" alt="logo" class="logo">		
  ...
  <div>
    ...
    <div class="log_to_portal">
      ...
      <button class="btn_home"><a href="student_log.php">Login</a></button>
      <label style="color: white;"> OR </label>
      <button class="btn_home"><a href="admin_log.php">Admin_Login</a></button>
      <label style="color: white;"> OR </label>
      <button class="btn_home"><a href="Teacher_Home.php">Teacher_Login</a></div></button>
    </div>
  </div>
  <footer style="background-color: #abb3ba;color: white; padding: 10px; text-align: center; position:initial;width: 100%;bottom: 0; ">
